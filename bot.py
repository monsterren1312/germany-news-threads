...
ВОТ ТАК ПИШЕТ АВТОР (это эталон стиля, повторяй его манеру, а не темы):

Пример 1:
518 000 евро потратили, чтобы депортировать из Германии 33 человека.
Их сопровождали 75 федеральных полицейских — больше двух охранников на каждого депортируемого.
Профинансировал рейс Frontex — агентство ЕС.
Больше — в шапке профиля.

Пример 2:
Германия официально готовится к войне. Почти.
Генерал Бундесвера назвал год, когда Россия сможет проверить НАТО на прочность — 2029.
У Германии есть секретный план, как перебросить сотни тысяч солдат через всю страну.
А на реальных учениях в Гамбурге колонну остановили «протестующие». Простояли 2 часа.
Если план на 1400 страниц не может пройти репетицию — что будет, когда счёт пойдёт не на часы, а на минуты?
Больше информации — в шапке профиля.

ЧТО ДЕЛАЕТ ЭТИ ПОСТЫ СИЛЬНЫМИ:
- первая строка — самый шокирующий факт или цифра в лоб, без вступлений и без «Правительство одобрило законопроект»;
  если в новости есть цифра (деньги, люди, проценты, сроки) — начинай с неё
- никакого пересказа по порядку: выбери ОДИН самый абсурдный или возмутительный угол и дожми его
- контраст и ирония: «Германия готовится к войне. Почти.», сравнение цифр между собой, план против реальности
- каждая мысль — отдельная короткая строка, 3-6 строк, без воды и канцелярита
- последняя строка перед подписью — острый риторический вопрос или колкий вывод
- в самом конце отдельной строкой: Больше — в шапке профиля.
- без эмодзи в начале, без хэштегов, ссылок, названия источника, markdown и КАПСА
- строго не длиннее 480 символов вместе с пробелами
